function [S1, S3] = AnaSolPoyntin(E0, f, epsilon_1, epsilon_2, mui_1, mui_2, d, x_S1)
...
k1 = 2 * pi * f * sqrt(epsilon_1/mui_1);
...
S1 = 0.5 * E0 * conj(E0) / Z1 * (1 - r^2) + imag((Ze - Z1) / (Ze + Z1)) * E0 * conj(E0) / Z1 * cos(2*k1*x_S1);
