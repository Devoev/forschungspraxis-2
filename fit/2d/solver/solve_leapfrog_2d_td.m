function [ebow_new,hbow_new]=solve_leapfrog_2d_td(ebow_old,hbow_old,e_exi_old,e_exi_new,jsbow,mmui,mepsi,c,dt,W)
...
%                 (3*np x 1)
    ...
    ebow_new = (e_exi_old + W*W'*ebow_old) + dt*mepsi*(c'*hbow_new - jsbow);
